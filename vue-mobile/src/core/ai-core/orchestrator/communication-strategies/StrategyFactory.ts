...
import { CommunicationContext, CommunicationIntent, Emotion } from '../../types';
...
export interface StrategyFactoryDependencies {
  ...
  determineIntent: (context: CommunicationContext, personality: any) => CommunicationIntent;
  determineEmotion: (context: CommunicationContext, personality: any) => Emotion;
